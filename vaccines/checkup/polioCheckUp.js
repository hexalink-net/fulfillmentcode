...
const vaksinPolioCheckUp = (agent) => {
    ...
    if (params.umur.unit == "month") {
        if (params.umur.amount >= 0 && params.umur.amount <= 1) {
            answer = `Pada umur ${params.umur.amount} ${params.umur.unit}, anak anda bisa diberikan vaksin polio dalam bentuk OPV (tetes mulut).
            `
            agent.add(answer + disclaimer)
            return
            ...
            if (params.umur.amount == 3 && params.frekuensiVaksin == 1){
                answer = `Jika anakmu berumur ${params.umur.amount} ${params.umur.unit} dan baru mendapatkan dosis satu, anak anda bisa diberikan vaksin polio dosis 2 dalam bentuk IPV (suntik) dan untuk vaksinasi polio selanjutnya antara dosis 2 dan 3 akan diperpendek dari 1 bulan menjadi 2-4 minggu.
                `
                agent.add(answer + disclaimer)
                return
            }
            answer = `Pada umur ${params.umur.amount} ${params.umur.unit}, anak anda bisa diberikan vaksin polio dalam bentuk IPV (suntik).
            `
            agent.add(answer + disclaimer)
            return
            ...
            if (params.frekuensiVaksin == 3){
                ...
                answer = `Jika anakmu berumur ${params.umur.amount} ${params.umur.unit} dan baru mendapatkan dosis satu, anak anda bisa diberikan vaksin polio dosis dua dalam bentuk IPV (suntik) dan untuk vaksinasi polio selanjutnya antara dosis 2 dan 3 akan diperpendek dari 1 bulan menjadi 2-4 minggu.
                `
                agent.add(answer + disclaimer)
                return
            } else if (params.frekuensiVaksin == 2){
                answer = `Jika anakmu berumur ${params.umur.amount} ${params.umur.unit} dan baru mendapatkan dosis dua, anak anda bisa diberikan vaksin polio dosis tiga dalam bentuk IPV (suntik) dan untuk vaksinasi polio selanjutnya antara dosis 3 dan 4 akan diperpendek dari 1 bulan menjadi 2-4 minggu.
                `
                agent.add(answer + disclaimer)
                return
            }
